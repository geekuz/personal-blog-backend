...
class FlywayUpgradeIntegrationTest {
    @Test
    void upgradesAnExistingVersionSevenDatabaseToNewsletterSchema() throws Exception {
        ...
        try (var connection = DriverManager.getConnection(url, "sa", "");
             ...
             var result = statement.executeQuery(
                 "select count(*) from information_schema.tables where table_name = 'newsletter_subscriptions'")) {
